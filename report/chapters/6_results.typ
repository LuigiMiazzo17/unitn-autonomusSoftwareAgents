...
#align(center)[
  ...
  #figure(
    table(
      ...
      inset: 6pt,
      align: horizon,
      table.header([*Map Name*], [*Custom Planner*], [*PDDL*]),
      [25c1_1], [344], [0],
      [25c1_2], [279], [31],
      [25c1_3], [611], [40],
      [25c1_4], [83], [7],
  ...
  #figure(
    table(
      ...
      inset: 6pt,
      align: horizon,
      table.header([*Map Name*], [*Agent 1*], [*Agent 2*], [*Sum of Agents*]),
      [25c2_1], [440], [335], [775],
      [25c2_2], [240], [168], [408],
      [25c2_3], [382], [252], [634],
      [25c2_4], [268], [244], [512],
...
Two cooperating agents on average outperform a single agent. The gain comes from broader spawnable-tile coverage and the ability to collect and deliver parcels in parallel. The handoff mechanism provides an additional benefit when delivery tiles are clustered far from the spawnable region: one agent can specialise in collection while the other delivers, reducing idle travel for both.
